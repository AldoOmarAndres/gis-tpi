  ...
  return (
    <div className="flex flex-col justify-center bg-sidebar rounded-lg">
      <Button
        ...
        variant="ghost"
        size="icon"
        className="h-8 w-full text-xl hover:bg-stone-200"
        onClick={() => zoomTo(+1)}
        title="Zoom In"
      >
        <svg
...
function HandIcon() {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 512 512"
      className="h-8 w-8 text-xl hover:bg-stone-200"
    >
  ...
  return (
    ...
    >
      <ToggleGroupItem
        ...
        title="Navegación"
        className="h-8 w-8 hover:bg-stone-200 data-[state=on]:bg-stone-300"
      >
        <HandIcon />
      </ToggleGroupItem>
      <ToggleGroupItem
  ...
  return (
    <div className="absolute m-2 flex flex-col justify-center gap-2">
      <div className="bg-sidebar rounded-lg">
        <SidebarTrigger
          className="h-8 w-full hover:bg-stone-200"
