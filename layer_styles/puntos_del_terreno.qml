...
<qgis styleCategories="AllStyleCategories" autoRefreshTime="0" simplifyDrawingHints="0" version="3.40.1-Bratislava" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" symbologyReferenceScale="-1" readOnly="0" simplifyAlgorithm="0" maxScale="0" simplifyLocal="1" minScale="100000000" autoRefreshMode="Disabled" simplifyMaxScale="1" labelsEnabled="0">
  ...
  <elevation extrusionEnabled="0" zscale="1" binding="Centroid" showMarkerSymbolInSurfacePlots="0" zoffset="0" respectLayerSymbol="1" clamping="Terrain" type="IndividualFeatures" extrusion="0" symbology="Line">
    ...
    <profileLineSymbol>
      <symbol name="" force_rhr="0" frame_rate="10" is_animated="0" alpha="1" clip_to_extent="1" type="line">
        ...
        <layer pass="0" enabled="1" locked="0" id="{2aa65046-4775-483c-830b-f6e5ca046621}" class="SimpleLine">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol name="" force_rhr="0" frame_rate="10" is_animated="0" alpha="1" clip_to_extent="1" type="fill">
        ...
        <layer pass="0" enabled="1" locked="0" id="{5f5dcd03-9923-480f-873d-97ff9ae7a629}" class="SimpleFill">
          <Option type="Map">
    ...
    <profileMarkerSymbol>
      <symbol name="" force_rhr="0" frame_rate="10" is_animated="0" alpha="1" clip_to_extent="1" type="marker">
        ...
        <layer pass="0" enabled="1" locked="0" id="{ede0b266-8e34-4829-9b9c-5c4a5831275e}" class="SimpleMarker">
          <Option type="Map">
  ...
  <renderer-v2 symbollevels="0" forceraster="0" referencescale="-1" enableorderby="0" type="singleSymbol">
    <symbols>
      <symbol name="0" force_rhr="0" frame_rate="10" is_animated="0" alpha="1" clip_to_extent="1" type="marker">
        ...
        <layer pass="0" enabled="1" locked="0" id="{e2811f98-a44b-4eba-881c-e7ad7655196d}" class="SimpleMarker">
          <Option type="Map">
            <Option name="angle" value="0" type="QString"/>
            <Option name="cap_style" value="square" type="QString"/>
            <Option name="color" value="0,0,0,255,hsv:0.04297222222222222,0,0,1" type="QString"/>
            <Option name="horizontal_anchor_point" value="1" type="QString"/>
            <Option name="joinstyle" value="bevel" type="QString"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol name="" force_rhr="0" frame_rate="10" is_animated="0" alpha="1" clip_to_extent="1" type="marker">
        ...
        <layer pass="0" enabled="1" locked="0" id="{028a6602-5ba2-4a4d-ac31-c3b24c812afa}" class="SimpleMarker">
          <Option type="Map">
            <Option name="angle" value="0" type="QString"/>
            <Option name="cap_style" value="square" type="QString"/>
  ...
  <aliases>
    ...
    <alias index="19" name="" field="cell_name"/>
    <alias index="20" name="" field="igds_type"/>
    <alias index="21" name="" field="igds_weigh"/>
    <alias index="22" name="" field="rotation"/>
    <alias index="23" name="" field="igds_color"/>
    <alias index="24" name="" field="group"/>
    <alias index="25" name="" field="igds_level"/>
    <alias index="26" name="" field="cotbase"/>
  </aliases>
  <splitPolicies>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" exp_strength="0" constraints="0" notnull_strength="0" field="cotbase"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint desc="" field="cotbase" exp=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
    <defaultAction key="Canvas" value="{00000000-0000-0000-0000-000000000000}"/>
  </attributeactions>
  <attributetableconfig sortExpression="&quot;signo&quot;" actionWidgetStyle="dropDown" sortOrder="0">
    <columns>
      ...
      <column name="cotbase" width="-1" type="field" hidden="0"/>
