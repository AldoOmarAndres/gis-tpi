...
<qgis hasScaleBasedVisibilityFlag="0" readOnly="0" styleCategories="AllStyleCategories" minScale="100000000" autoRefreshTime="0" simplifyLocal="1" labelsEnabled="0" symbologyReferenceScale="-1" simplifyDrawingHints="1" maxScale="0" autoRefreshMode="Disabled" simplifyAlgorithm="0" simplifyDrawingTol="1" simplifyMaxScale="1" version="3.40.1-Bratislava">
  ...
  <elevation clamping="Terrain" respectLayerSymbol="1" extrusionEnabled="0" zscale="1" extrusion="0" symbology="Line" zoffset="0" showMarkerSymbolInSurfacePlots="0" binding="Centroid" type="IndividualFeatures">
    ...
    <profileLineSymbol>
      <symbol clip_to_extent="1" is_animated="0" name="" force_rhr="0" alpha="1" frame_rate="10" type="line">
        ...
        <layer enabled="1" id="{6024efd8-5dbf-49dd-be3e-640acf8c869d}" pass="0" locked="0" class="SimpleLine">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol clip_to_extent="1" is_animated="0" name="" force_rhr="0" alpha="1" frame_rate="10" type="fill">
        ...
        <layer enabled="1" id="{a9be682d-9ec6-47ff-8999-01b6bfe6cd9b}" pass="0" locked="0" class="SimpleFill">
          <Option type="Map">
    ...
    <profileMarkerSymbol>
      <symbol clip_to_extent="1" is_animated="0" name="" force_rhr="0" alpha="1" frame_rate="10" type="marker">
        ...
        <layer enabled="1" id="{7b1ada7d-ddd5-4b00-8058-d59959c4690b}" pass="0" locked="0" class="SimpleMarker">
          <Option type="Map">
  ...
  <renderer-v2 attr="tipo" enableorderby="0" symbollevels="0" forceraster="0" referencescale="-1" type="categorizedSymbol">
    <categories>
      <category render="true" label="Bañado Intermitente" uuid="{65c62d13-8004-4667-8d3e-64cc4e14c876}" symbol="0" value="Bañado Intermitente" type="string"/>
      <category render="true" label="Bañado Perenne" uuid="{77441d6a-63af-478a-b189-a93ffa7395f3}" symbol="1" value="Bañado Perenne" type="string"/>
      <category render="true" label="Canal" uuid="{5672d62c-cb50-445c-a951-09ac8160c43a}" symbol="2" value="Canal" type="string"/>
      <category render="true" label="Corriente de Agua Perenne" uuid="{ce39ee44-b31d-4d74-bb70-48956e784853}" symbol="3" value="Corriente de Agua Perenne" type="string"/>
      <category render="true" label="Estero" uuid="{5beb6a72-8b9a-481a-9c3c-98a13ce40bf8}" symbol="4" value="Estero" type="string"/>
      <category render="true" label="Lago o Laguna Intermitente" uuid="{d9c9e4fc-3a25-4826-a7bd-2cbd0de55bfc}" symbol="5" value="Lago o Laguna Intermitente" type="string"/>
      <category render="true" label="Lago o Laguna Perenne" uuid="{9f5c29f2-be73-48dd-a9b1-4fd96e712e4d}" symbol="6" value="Lago o Laguna Perenne" type="string"/>
      <category render="true" label="" uuid="{d6e145ac-4dd5-48fa-8d46-9d5e86c48bea}" symbol="7" value="NULL" type="NULL"/>
    </categories>
    <symbols>
      <symbol clip_to_extent="1" is_animated="0" name="0" force_rhr="0" alpha="1" frame_rate="10" type="fill">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
        ...
        <layer enabled="1" id="{543b256b-bd9a-49bd-8901-8cc1c93163d9}" pass="0" locked="0" class="LinePatternFill">
          <Option type="Map">
            <Option name="angle" value="0" type="QString"/>
            <Option name="clip_mode" value="before_render" type="QString"/>
            <Option name="color" value="92,186,230,255,hsv:0.55277777777777781,0.59999999999999998,0.90196078431372551,1" type="QString"/>
          ...
          <symbol clip_to_extent="1" is_animated="0" name="@0@0" force_rhr="0" alpha="1" frame_rate="10" type="line">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" value="" type="QString"/>
                <Option name="properties"/>
            ...
            <layer enabled="1" id="{483efd95-87fa-4c97-85e6-a276a733773b}" pass="0" locked="0" class="SimpleLine">
              <Option type="Map">
                <Option name="align_dash_pattern" value="0" type="QString"/>
                <Option name="capstyle" value="square" type="QString"/>
                <Option name="customdash" value="10;2.5;5;2.5" type="QString"/>
                <Option name="customdash_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
                <Option name="customdash_unit" value="MM" type="QString"/>
                <Option name="dash_pattern_offset" value="0" type="QString"/>
                <Option name="dash_pattern_offset_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
                ...
                <Option name="draw_inside_polygon" value="0" type="QString"/>
                <Option name="joinstyle" value="bevel" type="QString"/>
                <Option name="line_color" value="92,186,230,255,hsv:0.55277777777777781,0.59999999999999998,0.90196078431372551,1" type="QString"/>
                <Option name="line_style" value="solid" type="QString"/>
      ...
      <symbol clip_to_extent="1" is_animated="0" name="1" force_rhr="0" alpha="1" frame_rate="10" type="fill">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
        ...
        <layer enabled="1" id="{543b256b-bd9a-49bd-8901-8cc1c93163d9}" pass="0" locked="0" class="LinePatternFill">
          ...
          <symbol clip_to_extent="1" is_animated="0" name="@1@0" force_rhr="0" alpha="1" frame_rate="10" type="line">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" value="" type="QString"/>
                <Option name="properties"/>
            ...
            <layer enabled="1" id="{483efd95-87fa-4c97-85e6-a276a733773b}" pass="0" locked="0" class="SimpleLine">
              <Option type="Map">
                ...
                <Option name="customdash" value="10;1;0.5;1" type="QString"/>
                <Option name="customdash_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
                <Option name="customdash_unit" value="MM" type="QString"/>
                <Option name="dash_pattern_offset" value="0" type="QString"/>
                <Option name="dash_pattern_offset_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
      ...
      <symbol clip_to_extent="1" is_animated="0" name="2" force_rhr="0" alpha="1" frame_rate="10" type="fill">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
        ...
        <layer enabled="1" id="{d916c40d-c507-42cb-a609-8deaf8003624}" pass="0" locked="0" class="SimpleFill">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
            <Option name="color" value="204,32,230,255,hsv:0.81111111111111112,0.86274509803921573,0.90196078431372551,1" type="QString"/>
            <Option name="joinstyle" value="bevel" type="QString"/>
            <Option name="offset" value="0,0" type="QString"/>
            <Option name="offset_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
            <Option name="offset_unit" value="MM" type="QString"/>
      ...
      <symbol clip_to_extent="1" is_animated="0" name="3" force_rhr="0" alpha="1" frame_rate="10" type="fill">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
        ...
        <layer enabled="1" id="{d916c40d-c507-42cb-a609-8deaf8003624}" pass="0" locked="0" class="SimpleFill">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
            <Option name="color" value="206,89,134,255,hsv:0.93611111111111112,0.56862745098039214,0.80784313725490198,1" type="QString"/>
            <Option name="joinstyle" value="bevel" type="QString"/>
            <Option name="offset" value="0,0" type="QString"/>
            <Option name="offset_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
            <Option name="offset_unit" value="MM" type="QString"/>
      ...
      <symbol clip_to_extent="1" is_animated="0" name="4" force_rhr="0" alpha="1" frame_rate="10" type="fill">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
        ...
        <layer enabled="1" id="{d916c40d-c507-42cb-a609-8deaf8003624}" pass="0" locked="0" class="SimpleFill">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
            <Option name="color" value="223,102,38,255,hsv:0.05833333333333333,0.83137254901960789,0.87450980392156863,1" type="QString"/>
            <Option name="joinstyle" value="bevel" type="QString"/>
            <Option name="offset" value="0,0" type="QString"/>
            <Option name="offset_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
            <Option name="offset_unit" value="MM" type="QString"/>
      ...
      <symbol clip_to_extent="1" is_animated="0" name="5" force_rhr="0" alpha="1" frame_rate="10" type="fill">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
        ...
        <layer enabled="1" id="{d916c40d-c507-42cb-a609-8deaf8003624}" pass="0" locked="0" class="SimpleFill">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
            <Option name="color" value="114,206,171,255,hsv:0.43611111111111112,0.44705882352941179,0.80784313725490198,1" type="QString"/>
            <Option name="joinstyle" value="bevel" type="QString"/>
            <Option name="offset" value="0,0" type="QString"/>
            <Option name="offset_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
            <Option name="offset_unit" value="MM" type="QString"/>
      ...
      <symbol clip_to_extent="1" is_animated="0" name="6" force_rhr="0" alpha="1" frame_rate="10" type="fill">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
        ...
        <layer enabled="1" id="{d916c40d-c507-42cb-a609-8deaf8003624}" pass="0" locked="0" class="SimpleFill">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
            <Option name="color" value="219,229,134,255,hsv:0.18333333333333332,0.41568627450980394,0.89803921568627454,1" type="QString"/>
            <Option name="joinstyle" value="bevel" type="QString"/>
            <Option name="offset" value="0,0" type="QString"/>
            <Option name="offset_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
            <Option name="offset_unit" value="MM" type="QString"/>
      ...
      <symbol clip_to_extent="1" is_animated="0" name="7" force_rhr="0" alpha="1" frame_rate="10" type="fill">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
        ...
        <layer enabled="1" id="{d916c40d-c507-42cb-a609-8deaf8003624}" pass="0" locked="0" class="SimpleFill">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
            <Option name="color" value="73,236,44,255,hsv:0.30833333333333335,0.81176470588235294,0.92549019607843142,1" type="QString"/>
            <Option name="joinstyle" value="bevel" type="QString"/>
            <Option name="offset" value="0,0" type="QString"/>
            <Option name="offset_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
            <Option name="offset_unit" value="MM" type="QString"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol clip_to_extent="1" is_animated="0" name="" force_rhr="0" alpha="1" frame_rate="10" type="fill">
        ...
        <layer enabled="1" id="{6cb82af1-edf2-4330-ba07-7370f14b9eed}" pass="0" locked="0" class="SimpleFill">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="NoFlag" name="cuenca">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field configurationFlags="NoFlag" name="uso">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field configurationFlags="NoFlag" name="salinidad">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field configurationFlags="NoFlag" name="régimen">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field configurationFlags="NoFlag" name="navegabili">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="cuenca" expression=""/>
    <default applyOnUpdate="0" field="uso" expression=""/>
    <default applyOnUpdate="0" field="salinidad" expression=""/>
    <default applyOnUpdate="0" field="régimen" expression=""/>
    <default applyOnUpdate="0" field="navegabili" expression=""/>
  ...
  <constraints>
    ...
    <constraint constraints="0" exp_strength="0" field="cuenca" unique_strength="0" notnull_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="uso" unique_strength="0" notnull_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="salinidad" unique_strength="0" notnull_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="régimen" unique_strength="0" notnull_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="navegabili" unique_strength="0" notnull_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="salinidad"/>
    <constraint exp="" desc="" field="régimen"/>
    <constraint exp="" desc="" field="navegabili"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="&quot;navegabili&quot;" sortOrder="0">
    <columns>
      ...
      <column hidden="0" name="tipo" width="311" type="field"/>
      ...
      <column hidden="0" name="cuenca" width="-1" type="field"/>
      <column hidden="0" name="uso" width="-1" type="field"/>
      <column hidden="0" name="salinidad" width="-1" type="field"/>
      <column hidden="0" name="navegabili" width="-1" type="field"/>
      ...
      <column hidden="0" name="régimen" width="-1" type="field"/>
