...
<qgis version="3.34.11-Prizren" readOnly="0" labelsEnabled="0" simplifyMaxScale="1" styleCategories="AllStyleCategories" simplifyLocal="1" symbologyReferenceScale="-1" simplifyDrawingTol="1" maxScale="0" minScale="100000000" simplifyDrawingHints="1" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
  ...
  <elevation showMarkerSymbolInSurfacePlots="0" extrusionEnabled="0" binding="Centroid" type="IndividualFeatures" respectLayerSymbol="1" clamping="Terrain" zoffset="0" zscale="1" extrusion="0" symbology="Line">
    ...
    <profileLineSymbol>
      <symbol frame_rate="10" alpha="1" clip_to_extent="1" is_animated="0" type="line" name="" force_rhr="0">
        ...
        <layer class="SimpleLine" locked="0" pass="0" enabled="1" id="{6024efd8-5dbf-49dd-be3e-640acf8c869d}">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol frame_rate="10" alpha="1" clip_to_extent="1" is_animated="0" type="fill" name="" force_rhr="0">
        ...
        <layer class="SimpleFill" locked="0" pass="0" enabled="1" id="{a9be682d-9ec6-47ff-8999-01b6bfe6cd9b}">
          <Option type="Map">
    ...
    <profileMarkerSymbol>
      <symbol frame_rate="10" alpha="1" clip_to_extent="1" is_animated="0" type="marker" name="" force_rhr="0">
        ...
        <layer class="SimpleMarker" locked="0" pass="0" enabled="1" id="{7b1ada7d-ddd5-4b00-8058-d59959c4690b}">
          <Option type="Map">
  ...
  <renderer-v2 forceraster="0" referencescale="-1" type="singleSymbol" enableorderby="0" symbollevels="0">
    <symbols>
      <symbol frame_rate="10" alpha="1" clip_to_extent="1" is_animated="0" type="fill" name="0" force_rhr="0">
        ...
        <layer class="SimpleFill" locked="0" pass="0" enabled="1" id="{d916c40d-c507-42cb-a609-8deaf8003624}">
          <Option type="Map">
            <Option type="QString" name="border_width_map_unit_scale" value="3x:0,0,0,0,0,0"/>
  ...
  <aliases>
    ...
    <alias name="" field="r??gimen" index="21"/>
  ...
  <splitPolicies>
    ...
    <policy policy="Duplicate" field="salinidad"/>
    <policy policy="Duplicate" field="r??gimen"/>
    <policy policy="Duplicate" field="navegabili"/>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" notnull_strength="0" field="uso" unique_strength="0" constraints="0"/>
    <constraint exp_strength="0" notnull_strength="0" field="salinidad" unique_strength="0" constraints="0"/>
    <constraint exp_strength="0" notnull_strength="0" field="r??gimen" unique_strength="0" constraints="0"/>
    <constraint exp_strength="0" notnull_strength="0" field="navegabili" unique_strength="0" constraints="0"/>
