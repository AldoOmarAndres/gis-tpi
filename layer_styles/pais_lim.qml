...
<qgis hasScaleBasedVisibilityFlag="0" readOnly="0" autoRefreshTime="0" simplifyDrawingHints="1" styleCategories="AllStyleCategories" autoRefreshMode="Disabled" labelsEnabled="0" minScale="100000000" simplifyAlgorithm="0" simplifyMaxScale="1" simplifyLocal="1" maxScale="0" simplifyDrawingTol="1" version="3.40.0-Bratislava" symbologyReferenceScale="-1">
  ...
  <elevation binding="Centroid" showMarkerSymbolInSurfacePlots="0" zoffset="0" clamping="Terrain" symbology="Line" zscale="1" extrusionEnabled="0" extrusion="0" type="IndividualFeatures" respectLayerSymbol="1">
    ...
    <profileLineSymbol>
      <symbol clip_to_extent="1" is_animated="0" alpha="1" frame_rate="10" name="" type="line" force_rhr="0">
        ...
        <layer class="SimpleLine" enabled="1" locked="0" pass="0" id="{a108e8e4-6a21-4934-b715-e31fb4407491}">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol clip_to_extent="1" is_animated="0" alpha="1" frame_rate="10" name="" type="fill" force_rhr="0">
        ...
        <layer class="SimpleFill" enabled="1" locked="0" pass="0" id="{cad3d344-f4c2-48dc-a09f-c0dbd3e91283}">
          <Option type="Map">
    ...
    <profileMarkerSymbol>
      <symbol clip_to_extent="1" is_animated="0" alpha="1" frame_rate="10" name="" type="marker" force_rhr="0">
        ...
        <layer class="SimpleMarker" enabled="1" locked="0" pass="0" id="{08b9bdf4-999c-46b7-85de-3f613ad2bd83}">
          <Option type="Map">
  ...
  <renderer-v2 enableorderby="0" forceraster="0" referencescale="-1" type="singleSymbol" symbollevels="0">
    <symbols>
      <symbol clip_to_extent="1" is_animated="0" alpha="1" frame_rate="10" name="0" type="fill" force_rhr="0">
        ...
        <layer class="SimpleFill" enabled="1" locked="0" pass="0" id="{33d1a9e0-5f15-41ea-a4bf-e88c5ac8f97a}">
          <Option type="Map">
            <Option value="3x:0,0,0,0,0,0" name="border_width_map_unit_scale" type="QString"/>
            <Option value="231,220,110,255,rgb:0.90774395361257343,0.86385900663767456,0.43158617532616161,1" name="color" type="QString"/>
            <Option value="bevel" name="joinstyle" type="QString"/>
            <Option value="0,0" name="offset" type="QString"/>
            <Option value="3x:0,0,0,0,0,0" name="offset_map_unit_scale" type="QString"/>
            <Option value="MM" name="offset_unit" type="QString"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol clip_to_extent="1" is_animated="0" alpha="1" frame_rate="10" name="" type="fill" force_rhr="0">
        ...
        <layer class="SimpleFill" enabled="1" locked="0" pass="0" id="{1c859f98-ada0-4ee0-84e5-67e11eb3523d}">
          <Option type="Map">
            <Option value="3x:0,0,0,0,0,0" name="border_width_map_unit_scale" type="QString"/>
  ...
  <LinearlyInterpolatedDiagramRenderer upperWidth="5" lowerValue="0" diagramType="Histogram" lowerHeight="0" upperValue="0" lowerWidth="0" upperHeight="5" classificationAttributeExpression="" attributeLegend="1">
    <DiagramCategory scaleBasedVisibility="0" spacingUnitScale="3x:0,0,0,0,0,0" opacity="1" width="15" showAxis="1" stackedDiagramSpacing="0" spacingUnit="MM" penAlpha="255" lineSizeScale="3x:0,0,0,0,0,0" backgroundAlpha="255" sizeType="MM" labelPlacementMethod="XHeight" stackedDiagramSpacingUnit="MM" penWidth="0" backgroundColor="#ffffff" penColor="#000000" stackedDiagramSpacingUnitScale="3x:0,0,0,0,0,0" rotationOffset="270" barWidth="5" enabled="0" maxScaleDenominator="1e+08" lineSizeType="MM" scaleDependency="Area" direction="0" minimumSize="0" diagramOrientation="Up" spacing="5" minScaleDenominator="0" sizeScale="3x:0,0,0,0,0,0" height="15" stackedDiagramMode="Horizontal">
      <fontProperties bold="0" underline="0" style="" strikethrough="0" description="MS Shell Dlg 2,7.8,-1,5,50,0,0,0,0,0" italic="0"/>
      ...
      <axisSymbol>
        <symbol clip_to_extent="1" is_animated="0" alpha="1" frame_rate="10" name="" type="line" force_rhr="0">
          ...
          <layer class="SimpleLine" enabled="1" locked="0" pass="0" id="{300768e3-084e-4dec-8cb7-8fb47565ef62}">
            <Option type="Map">
              <Option value="0" name="align_dash_pattern" type="QString"/>
              <Option value="square" name="capstyle" type="QString"/>
              <Option value="5;2" name="customdash" type="QString"/>
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="NoFlag" name="población">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field configurationFlags="NoFlag" name="Área_of">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field configurationFlags="NoFlag" name="moneda_of">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field configurationFlags="NoFlag" name="idioma_of">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field configurationFlags="NoFlag" name="continente">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias field="precisión" name="" index="2"/>
    <alias field="fuente" name="" index="3"/>
    <alias field="operador" name="" index="4"/>
    <alias field="dataset" name="" index="5"/>
    <alias field="fclass" name="" index="6"/>
    <alias field="responsabl" name="" index="7"/>
    <alias field="cargo" name="" index="8"/>
    <alias field="progreso" name="" index="9"/>
    <alias field="t_act" name="" index="10"/>
    <alias field="coord" name="" index="11"/>
    <alias field="sp" name="" index="12"/>
    <alias field="datum" name="" index="13"/>
    <alias field="ac" name="" index="14"/>
    <alias field="sigla" name="" index="15"/>
    <alias field="población" name="" index="16"/>
    <alias field="Área_of" name="" index="17"/>
    <alias field="moneda_of" name="" index="18"/>
    <alias field="idioma_of" name="" index="19"/>
    <alias field="continente" name="" index="20"/>
    <alias field="actualizac" name="" index="21"/>
    <alias field="igds_style" name="" index="22"/>
    <alias field="igds_type" name="" index="23"/>
    <alias field="igds_weigh" name="" index="24"/>
    <alias field="rotation" name="" index="25"/>
    <alias field="igds_color" name="" index="26"/>
    <alias field="group" name="" index="27"/>
    <alias field="igds_level" name="" index="28"/>
    <alias field="length" name="" index="29"/>
    <alias field="shape_area" name="" index="30"/>
  </aliases>
  <splitPolicies>
  ...
  <defaults>
    ...
    <default field="población" applyOnUpdate="0" expression=""/>
    <default field="Área_of" applyOnUpdate="0" expression=""/>
    <default field="moneda_of" applyOnUpdate="0" expression=""/>
    <default field="idioma_of" applyOnUpdate="0" expression=""/>
    <default field="continente" applyOnUpdate="0" expression=""/>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" field="sigla" notnull_strength="0" constraints="0" unique_strength="0"/>
    <constraint exp_strength="0" field="población" notnull_strength="0" constraints="0" unique_strength="0"/>
    <constraint exp_strength="0" field="Área_of" notnull_strength="0" constraints="0" unique_strength="0"/>
    <constraint exp_strength="0" field="moneda_of" notnull_strength="0" constraints="0" unique_strength="0"/>
    <constraint exp_strength="0" field="idioma_of" notnull_strength="0" constraints="0" unique_strength="0"/>
    <constraint exp_strength="0" field="continente" notnull_strength="0" constraints="0" unique_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" field="Área_of" desc=""/>
    <constraint exp="" field="moneda_of" desc=""/>
    <constraint exp="" field="idioma_of" desc=""/>
    <constraint exp="" field="continente" desc=""/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" name="sigla" type="field"/>
      <column width="-1" hidden="0" name="moneda_of" type="field"/>
      <column width="-1" hidden="0" name="idioma_of" type="field"/>
      <column width="-1" hidden="0" name="continente" type="field"/>
      ...
      <column width="-1" hidden="0" name="población" type="field"/>
      <column width="-1" hidden="0" name="Área_of" type="field"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field editable="1" name="idioma_of"/>
    ...
    <field editable="1" name="moneda_of"/>
    <field editable="1" name="nombre"/>
    <field editable="1" name="operador"/>
    <field editable="1" name="poblaci??n"/>
    ...
    <field editable="1" name="Área_of"/>
  </editable>
  <labelOnTop>
    <field labelOnTop="0" name="??rea_of"/>
    <field labelOnTop="0" name="ac"/>
    <field labelOnTop="0" name="actualizac"/>
    <field labelOnTop="0" name="cargo"/>
    <field labelOnTop="0" name="continente"/>
    ...
    <field labelOnTop="0" name="idioma_of"/>
    ...
    <field labelOnTop="0" name="moneda_of"/>
    <field labelOnTop="0" name="nombre"/>
    <field labelOnTop="0" name="operador"/>
    <field labelOnTop="0" name="poblaci??n"/>
    <field labelOnTop="0" name="población"/>
    <field labelOnTop="0" name="precisi??n"/>
    ...
    <field labelOnTop="0" name="Área_of"/>
  </labelOnTop>
  <reuseLastValue>
    <field reuseLastValue="0" name="??rea_of"/>
    <field reuseLastValue="0" name="ac"/>
    <field reuseLastValue="0" name="actualizac"/>
    <field reuseLastValue="0" name="cargo"/>
    <field reuseLastValue="0" name="continente"/>
    ...
    <field reuseLastValue="0" name="idioma_of"/>
    ...
    <field reuseLastValue="0" name="moneda_of"/>
    <field reuseLastValue="0" name="nombre"/>
    <field reuseLastValue="0" name="operador"/>
    <field reuseLastValue="0" name="poblaci??n"/>
    <field reuseLastValue="0" name="población"/>
    <field reuseLastValue="0" name="precisi??n"/>
    ...
    <field reuseLastValue="0" name="Área_of"/>
  </reuseLastValue>
