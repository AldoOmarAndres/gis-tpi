...
<qgis hasScaleBasedVisibilityFlag="0" readOnly="0" autoRefreshTime="0" simplifyDrawingHints="1" styleCategories="AllStyleCategories" autoRefreshMode="Disabled" labelsEnabled="0" minScale="100000000" simplifyAlgorithm="0" simplifyMaxScale="1" simplifyLocal="1" maxScale="0" simplifyDrawingTol="1" version="3.40.0-Bratislava" symbologyReferenceScale="-1">
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol clip_to_extent="1" is_animated="0" alpha="1" frame_rate="10" name="" type="line" force_rhr="0">
        ...
        <layer class="SimpleLine" enabled="1" locked="0" pass="0" id="{53f7c5fa-30f5-49db-b829-1172707219c2}">
          <Option type="Map">
            <Option value="0" name="align_dash_pattern" type="QString"/>
            <Option value="square" name="capstyle" type="QString"/>
            <Option value="5;2" name="customdash" type="QString"/>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" field="extensión" notnull_strength="0" constraints="0" unique_strength="0"/>
    <constraint exp_strength="0" field="estado" notnull_strength="0" constraints="0" unique_strength="0"/>
    <constraint exp_strength="0" field="actualizac" notnull_strength="0" constraints="0" unique_strength="0"/>
    <constraint exp_strength="0" field="claselim" notnull_strength="0" constraints="0" unique_strength="0"/>
    <constraint exp_strength="0" field="aclaracion" notnull_strength="0" constraints="0" unique_strength="0"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" name="extensión" type="field"/>
      <column width="-1" hidden="0" name="estado" type="field"/>
      <column width="-1" hidden="0" name="actualizac" type="field"/>
      <column width="-1" hidden="0" name="claselim" type="field"/>
      <column width="-1" hidden="0" name="aclaracion" type="field"/>
