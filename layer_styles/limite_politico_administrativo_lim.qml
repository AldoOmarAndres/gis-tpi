...
<qgis autoRefreshMode="Disabled" simplifyLocal="1" maxScale="0" minScale="100000000" simplifyDrawingTol="1" version="3.40.1-Bratislava" simplifyDrawingHints="1" labelsEnabled="0" symbologyReferenceScale="-1" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" autoRefreshTime="0" simplifyAlgorithm="0" simplifyMaxScale="1" readOnly="0">
  ...
  <elevation extrusion="0" symbology="Line" showMarkerSymbolInSurfacePlots="0" zoffset="0" respectLayerSymbol="1" clamping="Terrain" zscale="1" extrusionEnabled="0" binding="Centroid" type="IndividualFeatures">
    ...
    <profileLineSymbol>
      <symbol clip_to_extent="1" name="" force_rhr="0" is_animated="0" type="line" alpha="1" frame_rate="10">
        ...
        <layer pass="0" enabled="1" id="{331cc9ee-63d7-4a34-ba67-d351983aa39b}" class="SimpleLine" locked="0">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol clip_to_extent="1" name="" force_rhr="0" is_animated="0" type="fill" alpha="1" frame_rate="10">
        ...
        <layer pass="0" enabled="1" id="{4861cb36-ef17-4491-b9c6-005d8afb61e9}" class="SimpleFill" locked="0">
          <Option type="Map">
    ...
    <profileMarkerSymbol>
      <symbol clip_to_extent="1" name="" force_rhr="0" is_animated="0" type="marker" alpha="1" frame_rate="10">
        ...
        <layer pass="0" enabled="1" id="{197011a1-e512-4f6b-b908-73b9ebcb06d4}" class="SimpleMarker" locked="0">
          <Option type="Map">
  ...
  <renderer-v2 symbollevels="0" enableorderby="0" referencescale="-1" forceraster="0" type="singleSymbol">
    <symbols>
      <symbol clip_to_extent="1" name="0" force_rhr="0" is_animated="0" type="line" alpha="1" frame_rate="10">
        ...
        <layer pass="0" enabled="1" id="{7d8ea8b3-7401-4251-87e4-e424eb562e74}" class="SimpleLine" locked="0">
          <Option type="Map">
            <Option value="0" name="align_dash_pattern" type="QString"/>
            <Option value="square" name="capstyle" type="QString"/>
            <Option value="5;2" name="customdash" type="QString"/>
            ...
            <Option value="0" name="draw_inside_polygon" type="QString"/>
            <Option value="bevel" name="joinstyle" type="QString"/>
            <Option value="0,0,0,255,hsv:0.32197222222222222,0.28386358434424352,0,1" name="line_color" type="QString"/>
            <Option value="solid" name="line_style" type="QString"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol clip_to_extent="1" name="" force_rhr="0" is_animated="0" type="line" alpha="1" frame_rate="10">
        ...
        <layer pass="0" enabled="1" id="{53f7c5fa-30f5-49db-b829-1172707219c2}" class="SimpleLine" locked="0">
          <Option type="Map">
            <Option value="0" name="align_dash_pattern" type="QString"/>
            <Option value="square" name="capstyle" type="QString"/>
            <Option value="5;2" name="customdash" type="QString"/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="extensión" expression=""/>
    <default applyOnUpdate="0" field="estado" expression=""/>
    <default applyOnUpdate="0" field="actualizac" expression=""/>
    <default applyOnUpdate="0" field="claselim" expression=""/>
    <default applyOnUpdate="0" field="aclaracion" expression=""/>
  ...
  <constraints>
    ...
    <constraint constraints="0" unique_strength="0" notnull_strength="0" field="extensión" exp_strength="0"/>
    <constraint constraints="0" unique_strength="0" notnull_strength="0" field="estado" exp_strength="0"/>
    <constraint constraints="0" unique_strength="0" notnull_strength="0" field="actualizac" exp_strength="0"/>
    <constraint constraints="0" unique_strength="0" notnull_strength="0" field="claselim" exp_strength="0"/>
    <constraint constraints="0" unique_strength="0" notnull_strength="0" field="aclaracion" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="extensión"/>
    <constraint desc="" exp="" field="estado"/>
    <constraint desc="" exp="" field="actualizac"/>
    <constraint desc="" exp="" field="claselim"/>
    <constraint desc="" exp="" field="aclaracion"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column name="extensión" hidden="0" type="field" width="-1"/>
      <column name="estado" hidden="0" type="field" width="-1"/>
      <column name="actualizac" hidden="0" type="field" width="-1"/>
      <column name="claselim" hidden="0" type="field" width="-1"/>
      <column name="aclaracion" hidden="0" type="field" width="-1"/>
