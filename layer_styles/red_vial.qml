...
<qgis hasScaleBasedVisibilityFlag="0" readOnly="0" styleCategories="AllStyleCategories" minScale="100000000" autoRefreshTime="0" simplifyLocal="1" labelsEnabled="0" symbologyReferenceScale="-1" simplifyDrawingHints="1" maxScale="0" autoRefreshMode="Disabled" simplifyAlgorithm="0" simplifyDrawingTol="1" simplifyMaxScale="1" version="3.40.1-Bratislava">
  <flags>
  ...
  <temporal durationField="gid" limitMode="0" enabled="0" endExpression="" startField="" startExpression="" mode="0" endField="" durationUnit="min" fixedDuration="0" accumulate="0">
    <fixedRange>
      <start></start>
      <end></end>
    </fixedRange>
  </temporal>
  <elevation clamping="Terrain" respectLayerSymbol="1" extrusionEnabled="0" zscale="1" extrusion="0" symbology="Line" zoffset="0" showMarkerSymbolInSurfacePlots="0" binding="Centroid" type="IndividualFeatures">
    ...
    <profileLineSymbol>
      <symbol clip_to_extent="1" is_animated="0" name="" force_rhr="0" alpha="1" frame_rate="10" type="line">
        ...
        <layer enabled="1" id="{e3253b97-8d61-4a6e-a844-379e883edf10}" pass="0" locked="0" class="SimpleLine">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol clip_to_extent="1" is_animated="0" name="" force_rhr="0" alpha="1" frame_rate="10" type="fill">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
        ...
        <layer enabled="1" id="{0f15a4fc-fb37-4706-8c9f-1dc50ba410f7}" pass="0" locked="0" class="SimpleFill">
          <Option type="Map">
    ...
    <profileMarkerSymbol>
      <symbol clip_to_extent="1" is_animated="0" name="" force_rhr="0" alpha="1" frame_rate="10" type="marker">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
        ...
        <layer enabled="1" id="{aeb4e1c1-3fa1-455f-a306-edff8e6a185a}" pass="0" locked="0" class="SimpleMarker">
          <Option type="Map">
  ...
  <renderer-v2 attr="tipo" enableorderby="0" symbollevels="0" forceraster="0" referencescale="-1" type="categorizedSymbol">
    <categories>
      <category render="true" label="Autopista con Camino Pavimentado Dual con Separador" uuid="{fd106961-4705-4ba4-bb19-53bb911581e7}" symbol="0" value="Autopista con Camino Pavimentado Dual con Separador" type="string"/>
      <category render="true" label="Camino Consolidado, Camino sin Pavimentar de Transitavilidad Permanente" uuid="{f4990991-29b9-4540-b843-634d64e0b059}" symbol="1" value="Camino Consolidado, Camino sin Pavimentar de Transitavilidad Permanente" type="string"/>
      <category render="true" label="Camino de Tierra, Camino sin Pavimentar de Transitavilidad Temporaria" uuid="{eea7830a-9812-494f-aedd-e94fae94ca0c}" symbol="2" value="Camino de Tierra, Camino sin Pavimentar de Transitavilidad Temporaria" type="string"/>
      <category render="true" label="Camino Pavimentado" uuid="{869c044e-0bb1-4324-aa08-8f6cc5cf9a2b}" symbol="3" value="Camino Pavimentado" type="string"/>
      <category render="true" label="" uuid="{81e3f3ea-5d29-4a72-b3d4-f495b1d9556e}" symbol="4" value="NULL" type="NULL"/>
    </categories>
    <symbols>
      <symbol clip_to_extent="1" is_animated="0" name="0" force_rhr="0" alpha="1" frame_rate="10" type="line">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
        ...
        <layer enabled="1" id="{b995c5ea-4751-4f02-91eb-a888570f3e24}" pass="0" locked="0" class="SimpleLine">
          <Option type="Map">
            <Option name="align_dash_pattern" value="0" type="QString"/>
            <Option name="capstyle" value="square" type="QString"/>
            <Option name="customdash" value="5;2" type="QString"/>
            ...
            <Option name="draw_inside_polygon" value="0" type="QString"/>
            <Option name="joinstyle" value="bevel" type="QString"/>
            <Option name="line_color" value="74,217,188,255,hsv:0.46666666666666667,0.6588235294117647,0.85098039215686272,1" type="QString"/>
            <Option name="line_style" value="solid" type="QString"/>
      ...
      <symbol clip_to_extent="1" is_animated="0" name="1" force_rhr="0" alpha="1" frame_rate="10" type="line">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
        ...
        <layer enabled="1" id="{b995c5ea-4751-4f02-91eb-a888570f3e24}" pass="0" locked="0" class="SimpleLine">
          <Option type="Map">
            ...
            <Option name="draw_inside_polygon" value="0" type="QString"/>
            <Option name="joinstyle" value="bevel" type="QString"/>
            <Option name="line_color" value="137,230,75,255,hsv:0.26666666666666666,0.67450980392156867,0.90196078431372551,1" type="QString"/>
            <Option name="line_style" value="solid" type="QString"/>
            <Option name="line_width" value="0.26" type="QString"/>
            <Option name="line_width_unit" value="MM" type="QString"/>
            <Option name="offset" value="0" type="QString"/>
      ...
      <symbol clip_to_extent="1" is_animated="0" name="2" force_rhr="0" alpha="1" frame_rate="10" type="line">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
        ...
        <layer enabled="1" id="{b995c5ea-4751-4f02-91eb-a888570f3e24}" pass="0" locked="0" class="SimpleLine">
          <Option type="Map">
            ...
            <Option name="draw_inside_polygon" value="0" type="QString"/>
            <Option name="joinstyle" value="bevel" type="QString"/>
            <Option name="line_color" value="202,149,114,255,hsv:0.06666666666666667,0.43529411764705883,0.792156862745098,1" type="QString"/>
            <Option name="line_style" value="solid" type="QString"/>
            <Option name="line_width" value="0.26" type="QString"/>
            <Option name="line_width_unit" value="MM" type="QString"/>
            <Option name="offset" value="0" type="QString"/>
      ...
      <symbol clip_to_extent="1" is_animated="0" name="3" force_rhr="0" alpha="1" frame_rate="10" type="line">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
        ...
        <layer enabled="1" id="{b995c5ea-4751-4f02-91eb-a888570f3e24}" pass="0" locked="0" class="SimpleLine">
          <Option type="Map">
            ...
            <Option name="draw_inside_polygon" value="0" type="QString"/>
            <Option name="joinstyle" value="bevel" type="QString"/>
            <Option name="line_color" value="230,19,188,255,hsv:0.8666666666666667,0.91764705882352937,0.90196078431372551,1" type="QString"/>
            <Option name="line_style" value="solid" type="QString"/>
            <Option name="line_width" value="0.26" type="QString"/>
            <Option name="line_width_unit" value="MM" type="QString"/>
            <Option name="offset" value="0" type="QString"/>
      ...
      <symbol clip_to_extent="1" is_animated="0" name="4" force_rhr="0" alpha="1" frame_rate="10" type="line">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
        ...
        <layer enabled="1" id="{b995c5ea-4751-4f02-91eb-a888570f3e24}" pass="0" locked="0" class="SimpleLine">
          <Option type="Map">
            ...
            <Option name="draw_inside_polygon" value="0" type="QString"/>
            <Option name="joinstyle" value="bevel" type="QString"/>
            <Option name="line_color" value="33,33,202,255,hsv:0.66666666666666663,0.83529411764705885,0.792156862745098,1" type="QString"/>
            <Option name="line_style" value="solid" type="QString"/>
            <Option name="line_width" value="0.26" type="QString"/>
            <Option name="line_width_unit" value="MM" type="QString"/>
            <Option name="offset" value="0" type="QString"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol clip_to_extent="1" is_animated="0" name="" force_rhr="0" alpha="1" frame_rate="10" type="line">
        ...
        <layer enabled="1" id="{00572cab-13ef-4f83-a4bf-4f49a24d7769}" pass="0" locked="0" class="SimpleLine">
          <Option type="Map">
            <Option name="align_dash_pattern" value="0" type="QString"/>
            <Option name="capstyle" value="square" type="QString"/>
            <Option name="customdash" value="5;2" type="QString"/>
  ...
  <aliases>
    ...
    <alias name="" field="revestimie" index="19"/>
    <alias name="" field="carriles" index="20"/>
    <alias name="" field="tráfico" index="21"/>
    <alias name="" field="cante_div" index="22"/>
    <alias name="" field="de_carga" index="23"/>
    <alias name="" field="km_inicial" index="24"/>
    <alias name="" field="nro_ruta" index="25"/>
    <alias name="" field="actualizac" index="26"/>
    <alias name="" field="categoría" index="27"/>
    <alias name="" field="igds_style" index="28"/>
    <alias name="" field="igds_type" index="29"/>
    <alias name="" field="igds_weigh" index="30"/>
    <alias name="" field="rotation" index="31"/>
    <alias name="" field="igds_color" index="32"/>
    <alias name="" field="group" index="33"/>
    <alias name="" field="igds_level" index="34"/>
    <alias name="" field="progreso" index="35"/>
    <alias name="" field="length" index="36"/>
  </aliases>
  <splitPolicies>
    ...
    <policy field="revestimie" policy="Duplicate"/>
    <policy field="carriles" policy="Duplicate"/>
    <policy field="tráfico" policy="Duplicate"/>
    <policy field="cante_div" policy="Duplicate"/>
    <policy field="de_carga" policy="Duplicate"/>
    <policy field="km_inicial" policy="Duplicate"/>
    <policy field="nro_ruta" policy="Duplicate"/>
    <policy field="actualizac" policy="Duplicate"/>
    <policy field="categoría" policy="Duplicate"/>
  ...
  <constraints>
    ...
    <constraint constraints="0" exp_strength="0" field="revestimie" unique_strength="0" notnull_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="carriles" unique_strength="0" notnull_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="tráfico" unique_strength="0" notnull_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="cante_div" unique_strength="0" notnull_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="de_carga" unique_strength="0" notnull_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="km_inicial" unique_strength="0" notnull_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="nro_ruta" unique_strength="0" notnull_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="actualizac" unique_strength="0" notnull_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="categoría" unique_strength="0" notnull_strength="0"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column hidden="0" name="tipo" width="123" type="field"/>
      <column hidden="0" name="situación" width="-1" type="field"/>
      <column hidden="0" name="precisión" width="-1" type="field"/>
      <column hidden="0" name="escala" width="-1" type="field"/>
      <column hidden="0" name="signo" width="-1" type="field"/>
      <column hidden="0" name="fuente" width="-1" type="field"/>
      <column hidden="0" name="operador" width="-1" type="field"/>
      <column hidden="0" name="dataset" width="-1" type="field"/>
      <column hidden="0" name="fclass" width="-1" type="field"/>
      <column hidden="0" name="responsabl" width="-1" type="field"/>
      <column hidden="0" name="cargo" width="-1" type="field"/>
      <column hidden="0" name="t_act" width="-1" type="field"/>
      <column hidden="0" name="coord" width="-1" type="field"/>
      <column hidden="0" name="sp" width="-1" type="field"/>
      <column hidden="0" name="datum" width="-1" type="field"/>
      <column hidden="0" name="ac" width="-1" type="field"/>
      <column hidden="0" name="administra" width="-1" type="field"/>
      <column hidden="0" name="revestimie" width="-1" type="field"/>
      <column hidden="0" name="carriles" width="-1" type="field"/>
      <column hidden="0" name="tráfico" width="-1" type="field"/>
      <column hidden="0" name="cante_div" width="-1" type="field"/>
      <column hidden="0" name="de_carga" width="-1" type="field"/>
      <column hidden="0" name="km_inicial" width="-1" type="field"/>
      <column hidden="0" name="nro_ruta" width="-1" type="field"/>
      <column hidden="0" name="actualizac" width="-1" type="field"/>
      <column hidden="0" name="categoría" width="-1" type="field"/>
      <column hidden="0" name="igds_style" width="-1" type="field"/>
      <column hidden="0" name="igds_type" width="-1" type="field"/>
      <column hidden="0" name="igds_weigh" width="-1" type="field"/>
      <column hidden="0" name="rotation" width="-1" type="field"/>
      <column hidden="0" name="igds_color" width="-1" type="field"/>
      <column hidden="0" name="group" width="-1" type="field"/>
      <column hidden="0" name="igds_level" width="-1" type="field"/>
      <column hidden="0" name="progreso" width="-1" type="field"/>
