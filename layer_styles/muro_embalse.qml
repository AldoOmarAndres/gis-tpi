...
<qgis version="3.40.1-Bratislava" labelsEnabled="0" simplifyDrawingTol="1" hasScaleBasedVisibilityFlag="0" maxScale="0" styleCategories="AllStyleCategories" minScale="100000000" autoRefreshTime="0" readOnly="0" simplifyLocal="1" simplifyDrawingHints="1" simplifyAlgorithm="0" symbologyReferenceScale="-1" autoRefreshMode="Disabled" simplifyMaxScale="1">
  ...
  <elevation extrusion="0" binding="Centroid" zscale="1" zoffset="0" respectLayerSymbol="1" type="IndividualFeatures" showMarkerSymbolInSurfacePlots="0" clamping="Terrain" symbology="Line" extrusionEnabled="0">
    ...
    <profileLineSymbol>
      <symbol is_animated="0" type="line" force_rhr="0" clip_to_extent="1" name="" alpha="1" frame_rate="10">
        ...
        <layer class="SimpleLine" enabled="1" id="{a1014451-76ae-4bbf-8f97-782968c22b11}" pass="0" locked="0">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol is_animated="0" type="fill" force_rhr="0" clip_to_extent="1" name="" alpha="1" frame_rate="10">
        ...
        <layer class="SimpleFill" enabled="1" id="{9f492fa0-1f95-424c-98a3-d99fb5a64163}" pass="0" locked="0">
          <Option type="Map">
    ...
    <profileMarkerSymbol>
      <symbol is_animated="0" type="marker" force_rhr="0" clip_to_extent="1" name="" alpha="1" frame_rate="10">
        ...
        <layer class="SimpleMarker" enabled="1" id="{563d1027-e5ee-4ad1-976a-fa177d69c8ad}" pass="0" locked="0">
          <Option type="Map">
  ...
  <renderer-v2 type="singleSymbol" forceraster="0" referencescale="-1" enableorderby="0" symbollevels="0">
    <symbols>
      <symbol is_animated="0" type="line" force_rhr="0" clip_to_extent="1" name="0" alpha="1" frame_rate="10">
        ...
        <layer class="SimpleLine" enabled="1" id="{8649b0a6-e086-4273-a646-5102badac9ca}" pass="0" locked="0">
          <Option type="Map">
            <Option type="QString" value="0" name="align_dash_pattern"/>
            <Option type="QString" value="square" name="capstyle"/>
            <Option type="QString" value="5;2" name="customdash"/>
            ...
            <Option type="QString" value="0" name="draw_inside_polygon"/>
            <Option type="QString" value="bevel" name="joinstyle"/>
            <Option type="QString" value="0,0,0,255,hsv:0.18897222222222224,0,0,1" name="line_color"/>
            <Option type="QString" value="solid" name="line_style"/>
        ...
        <layer class="MarkerLine" enabled="1" id="{27022554-8248-49a7-abe5-2e736a2343c2}" pass="0" locked="0">
          <Option type="Map">
          ...
          <symbol is_animated="0" type="marker" force_rhr="0" clip_to_extent="1" name="@0@1" alpha="1" frame_rate="10">
            <data_defined_properties>
              <Option type="Map">
                <Option type="QString" value="" name="name"/>
                <Option name="properties"/>
            ...
            <layer class="SimpleMarker" enabled="1" id="{1e6c2fbf-928c-4800-b211-ed6e0dc0c5f3}" pass="0" locked="0">
              <Option type="Map">
                <Option type="QString" value="0" name="angle"/>
                <Option type="QString" value="square" name="cap_style"/>
                ...
                <Option type="QString" value="1" name="horizontal_anchor_point"/>
                <Option type="QString" value="bevel" name="joinstyle"/>
                <Option type="QString" value="quarter_arc" name="name"/>
                <Option type="QString" value="0,0" name="offset"/>
                <Option type="QString" value="3x:0,0,0,0,0,0" name="offset_map_unit_scale"/>
                <Option type="QString" value="MM" name="offset_unit"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol is_animated="0" type="line" force_rhr="0" clip_to_extent="1" name="" alpha="1" frame_rate="10">
        ...
        <layer class="SimpleLine" enabled="1" id="{a975d750-ef84-4cdb-ba5d-08a9cd284e70}" pass="0" locked="0">
          <Option type="Map">
            <Option type="QString" value="0" name="align_dash_pattern"/>
            <Option type="QString" value="square" name="capstyle"/>
            <Option type="QString" value="5;2" name="customdash"/>
  ...
  <constraints>
    ...
    <constraint constraints="0" exp_strength="0" field="situacion" unique_strength="0" notnull_strength="0"/>
  ...
  <attributetableconfig sortExpression="" actionWidgetStyle="dropDown" sortOrder="0">
    <columns>
      ...
      <column hidden="0" width="-1" type="field" name="situacion"/>
