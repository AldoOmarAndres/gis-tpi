...
<qgis version="3.40.1-Bratislava" labelsEnabled="0" simplifyDrawingTol="1" hasScaleBasedVisibilityFlag="0" maxScale="0" styleCategories="AllStyleCategories" minScale="100000000" autoRefreshTime="0" readOnly="0" simplifyLocal="1" simplifyDrawingHints="1" simplifyAlgorithm="0" symbologyReferenceScale="-1" autoRefreshMode="Disabled" simplifyMaxScale="1">
  ...
  <elevation extrusion="0" binding="Centroid" zscale="1" zoffset="0" respectLayerSymbol="1" type="IndividualFeatures" showMarkerSymbolInSurfacePlots="0" clamping="Terrain" symbology="Line" extrusionEnabled="0">
    ...
    <profileLineSymbol>
      <symbol is_animated="0" type="line" force_rhr="0" clip_to_extent="1" name="" alpha="1" frame_rate="10">
        ...
        <layer class="SimpleLine" enabled="1" id="{e3916928-d37b-4bc9-acac-eaee8a202e50}" pass="0" locked="0">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol is_animated="0" type="fill" force_rhr="0" clip_to_extent="1" name="" alpha="1" frame_rate="10">
        ...
        <layer class="SimpleFill" enabled="1" id="{ea955dc6-24d9-49e1-a8b8-d65ede1ecb98}" pass="0" locked="0">
          <Option type="Map">
    ...
    <profileMarkerSymbol>
      <symbol is_animated="0" type="marker" force_rhr="0" clip_to_extent="1" name="" alpha="1" frame_rate="10">
        ...
        <layer class="SimpleMarker" enabled="1" id="{8277bd81-50b3-409e-b925-3ae0e59eed65}" pass="0" locked="0">
          <Option type="Map">
  ...
  <renderer-v2 type="singleSymbol" forceraster="0" referencescale="-1" enableorderby="0" symbollevels="0">
    <symbols>
      <symbol is_animated="0" type="line" force_rhr="0" clip_to_extent="1" name="0" alpha="1" frame_rate="10">
        ...
        <layer class="SimpleLine" enabled="1" id="{8d7df6b2-d8d1-4570-ad1b-d9950d739854}" pass="0" locked="0">
          <Option type="Map">
            <Option type="QString" value="0" name="align_dash_pattern"/>
            <Option type="QString" value="square" name="capstyle"/>
            <Option type="QString" value="5;2" name="customdash"/>
            ...
            <Option type="QString" value="0" name="draw_inside_polygon"/>
            <Option type="QString" value="bevel" name="joinstyle"/>
            <Option type="QString" value="20,163,230,255,rgb:0.07843137254901961,0.63921568627450975,0.90196078431372551,1" name="line_color"/>
            <Option type="QString" value="solid" name="line_style"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol is_animated="0" type="line" force_rhr="0" clip_to_extent="1" name="" alpha="1" frame_rate="10">
        ...
        <layer class="SimpleLine" enabled="1" id="{7e85c369-9d5a-48b8-8e8a-ca84159af79c}" pass="0" locked="0">
          <Option type="Map">
            <Option type="QString" value="0" name="align_dash_pattern"/>
            <Option type="QString" value="square" name="capstyle"/>
            <Option type="QString" value="5;2" name="customdash"/>
  ...
  <constraints>
    ...
    <constraint constraints="0" exp_strength="0" field="contenido" unique_strength="0" notnull_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="coincide" unique_strength="0" notnull_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="navegable" unique_strength="0" notnull_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="profundida" unique_strength="0" notnull_strength="0"/>
  ...
  <attributetableconfig sortExpression="" actionWidgetStyle="dropDown" sortOrder="0">
    <columns>
      ...
      <column hidden="0" width="-1" type="field" name="cuenca"/>
      <column hidden="0" width="-1" type="field" name="contenido"/>
      <column hidden="0" width="-1" type="field" name="coincide"/>
      <column hidden="0" width="-1" type="field" name="navegable"/>
      <column hidden="0" width="-1" type="field" name="profundida"/>
      <column hidden="0" width="-1" type="field" name="régimen"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="coincide"/>
    <field labelOnTop="0" name="contenido"/>
    <field labelOnTop="0" name="coord"/>
    <field labelOnTop="0" name="cuenca"/>
