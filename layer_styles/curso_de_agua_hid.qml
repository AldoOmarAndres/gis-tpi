...
<qgis hasScaleBasedVisibilityFlag="0" readOnly="0" autoRefreshTime="0" simplifyDrawingHints="1" styleCategories="AllStyleCategories" autoRefreshMode="Disabled" labelsEnabled="0" minScale="100000000" simplifyAlgorithm="0" simplifyMaxScale="1" simplifyLocal="1" maxScale="0" simplifyDrawingTol="1" version="3.40.0-Bratislava" symbologyReferenceScale="-1">
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol clip_to_extent="1" is_animated="0" alpha="1" frame_rate="10" name="" type="line" force_rhr="0">
        ...
        <layer class="SimpleLine" enabled="1" locked="0" pass="0" id="{7e85c369-9d5a-48b8-8e8a-ca84159af79c}">
          <Option type="Map">
            <Option value="0" name="align_dash_pattern" type="QString"/>
            <Option value="square" name="capstyle" type="QString"/>
            <Option value="5;2" name="customdash" type="QString"/>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" field="cuenca" notnull_strength="0" constraints="0" unique_strength="0"/>
    <constraint exp_strength="0" field="contenido" notnull_strength="0" constraints="0" unique_strength="0"/>
    <constraint exp_strength="0" field="coincide" notnull_strength="0" constraints="0" unique_strength="0"/>
    <constraint exp_strength="0" field="navegable" notnull_strength="0" constraints="0" unique_strength="0"/>
    <constraint exp_strength="0" field="profundida" notnull_strength="0" constraints="0" unique_strength="0"/>
    <constraint exp_strength="0" field="régimen" notnull_strength="0" constraints="0" unique_strength="0"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" name="cuenca" type="field"/>
      <column width="-1" hidden="0" name="contenido" type="field"/>
      <column width="-1" hidden="0" name="coincide" type="field"/>
      <column width="-1" hidden="0" name="navegable" type="field"/>
      <column width="-1" hidden="0" name="profundida" type="field"/>
      <column width="-1" hidden="0" name="régimen" type="field"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field editable="1" name="coincide"/>
    <field editable="1" name="contenido"/>
