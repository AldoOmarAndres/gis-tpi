...
<qgis version="3.34.11-Prizren" readOnly="0" labelsEnabled="0" simplifyMaxScale="1" styleCategories="AllStyleCategories" simplifyLocal="1" symbologyReferenceScale="-1" simplifyDrawingTol="1" maxScale="0" minScale="100000000" simplifyDrawingHints="1" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0">
  ...
  <elevation showMarkerSymbolInSurfacePlots="0" extrusionEnabled="0" binding="Centroid" type="IndividualFeatures" respectLayerSymbol="1" clamping="Terrain" zoffset="0" zscale="1" extrusion="0" symbology="Line">
    ...
    <profileLineSymbol>
      <symbol frame_rate="10" alpha="1" clip_to_extent="1" is_animated="0" type="line" name="" force_rhr="0">
        ...
        <layer class="SimpleLine" locked="0" pass="0" enabled="1" id="{5d6995f9-927f-45b6-a6f4-c53b9ebfa6bd}">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol frame_rate="10" alpha="1" clip_to_extent="1" is_animated="0" type="fill" name="" force_rhr="0">
        ...
        <layer class="SimpleFill" locked="0" pass="0" enabled="1" id="{c98fb663-8751-4a62-9bf8-ba946953c39e}">
          <Option type="Map">
    ...
    <profileMarkerSymbol>
      <symbol frame_rate="10" alpha="1" clip_to_extent="1" is_animated="0" type="marker" name="" force_rhr="0">
        ...
        <layer class="SimpleMarker" locked="0" pass="0" enabled="1" id="{b1828800-f81c-4e73-a66c-468bbeb6c1fa}">
          <Option type="Map">
  ...
  <renderer-v2 forceraster="0" referencescale="-1" type="singleSymbol" enableorderby="0" symbollevels="0">
    <symbols>
      <symbol frame_rate="10" alpha="1" clip_to_extent="1" is_animated="0" type="line" name="0" force_rhr="0">
        ...
        <layer class="SimpleLine" locked="0" pass="0" enabled="1" id="{c57bbff3-a1c6-46c1-b120-a60e37a303fc}">
          <Option type="Map">
            <Option type="QString" name="align_dash_pattern" value="0"/>
            <Option type="QString" name="capstyle" value="square"/>
            <Option type="QString" name="customdash" value="5;2"/>
  ...
  <aliases>
    ...
    <alias name="" field="consesi??n" index="18"/>
  ...
  <defaults>
    ...
    <default expression="" applyOnUpdate="0" field="consesi??n"/>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" notnull_strength="0" field="consesi??n" unique_strength="0" constraints="0"/>
    <constraint exp_strength="0" notnull_strength="0" field="empresa" unique_strength="0" constraints="0"/>
